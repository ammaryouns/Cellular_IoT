...
*
* @note     (1) This function MUST be called with interrupts already disabled.
*
* @note     (2) Your ISR can directly increment 'OSIntNestingCtr' without calling this function because
...
*
* @note     (3) You MUST still call OSIntExit() even though you can increment 'OSIntNestingCtr' directly.
*
* @note     (4) You MUST invoke OSIntEnter() and OSIntExit() in pairs. In other words, for every call
...
*
* @note     (5) You are allowed to nest interrupts up to 250 levels deep.
*********************************************************************************************************
*/
